<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IVRRedemption.aspx.cs" Async="true" Inherits="IVR_Default"%>
...
<body class="hold-transition sidebar-mini">
    ...
    <ul class="navbar-nav left">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link active" style='color:white'>Redemption</a>
      </li>
      
         <li class="nav-item d-none d-sm-inline-block">
        <a  style='color:white' href="https://sma.jsil.com/signup/IVR/IVRTransfer.aspx" class="nav-link">Transfer</a>
                                                        ...
                                                        <div class="row">
                                                           ...
                                                           <div class="col-md-8">
                                                             ...
                                                             <div class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Redemption Type:</label></li>
                                                           ...
                                                           <div class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:DropDownList ID="dropDownRedemptionType"  onTextChanged="redemptionTypeChange" AutoPostBack="true" runat="server"  CssClass="form-control">
                                                           ...
                                                           <div class="col-md-8">
                                                             ...
                                                             <div class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Payment Instructions/Mode:</label></li>
                                                           ...
                                                           <div class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:DropDownList ID="dropDownPaymentType" AutoPostBack="true"  OnTextChanged="dropDownPaymentTypeChange" runat="server"  CssClass="form-control">
                                                             ...
                                                             <div id="divBankDetail1" runat="server"  class="col-md-12 mb-3">
                                                                <h3>Bank Details</h3>
                                                            </div>

                                                            
                                                             <div  id="divBankDetail2" runat="server" class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Bank Account No:</label></li>
                                                                    
                                                                </ul>
                                                            </div>
                                                          
                                                           <div  id="divBankDetail3"  runat="server" class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:TextBox ID="txtAccountNumber" CssClass="form-control txtFont" runat="server"></asp:TextBox>
                                                                        </li>
                                                                  ...
                                                                  <div   id="divBankDetail4" runat="server" class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Bank Account Title:</label></li>
                                                                    
                                                                </ul>
                                                            </div>
                                                          
                                                           <div  id="divBankDetail5" runat="server" class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:TextBox ID="txtBankAccountTitle" CssClass="form-control txtFont" runat="server"></asp:TextBox>
                                                                    
                                                                </ul>
                                                            </div>

                                                            
                                                                  <div  id="divBankDetail6" runat="server" class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Bank Name:</label></li>
                                                                    
                                                                </ul>
                                                            </div>
                                                          
                                                           <div  id="divBankDetail7" runat="server" class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:TextBox ID="txtBankName" CssClass="form-control txtFont" runat="server"></asp:TextBox>
                                                                    
                                                                </ul>
                                                            </div>

                                                            
                                                                  <div runat="server"  id="divBankDetail8" class="col-md-3">
                                                                <ul class="row">
                                                                    <li class="col-md-12">
                                                                        <label>Branch Code:</label></li>
                                                                    
                                                                </ul>
                                                            </div>
                                                          
                                                           <div runat="server"  id="divBankDetail9" class="col-md-8">
                                                                <ul class="row">
                                                                    <li class="col-md-8">
                                                                         <asp:TextBox ID="txtBranch" CssClass="form-control txtFont" runat="server"></asp:TextBox>
                                               ...
                                               <div class="modal fad" id="myModal" role="dialog">
                                                   <div class="modal-dialog modal-dialog-centered">
                                                       ...
                                                       <div class="modal-header">
                                                           <h4 class="modal-title">Redemption Detail</h4>
                                                             ...
                                                             <div  runat="server" class="container-fluid">
                                                                <div class="row">
                                                                    <div class="col-md-12 d-flex">
                                                                         ...
                                                                         <b><asp:Label CssClass="col-md-6" runat="server" id="folioText">47253</asp:Label></b>
                                                                    </div>
                                                                    <div class="col-md-12 d-flex">
                                                                         <asp:Label CssClass="col-md-6" runat="server" id="fundLabel">Fund Name: </asp:Label>
                                                                         <b><asp:Label CssClass="col-md-6" runat="server" id="fundText">JS Cash Fund</asp:Label></b>
                                                                    </div>
                                                                    <div class="col-md-12 d-flex">
                                                                         <asp:Label CssClass="col-md-6" runat="server" id="redemptionTypeLabel">Redemption Type: </asp:Label>
                                                                    ...
                                                                    <div class="col-md-12 d-flex">
                                                                         <asp:Label CssClass="col-md-6" runat="server" >Approximate Units: </asp:Label>
                                                                    ...
                                                                    <div class="col-md-8 d-flex">
                                                                        <asp:Button CssClass="btn btn-success" Text="Confirm" id="btnRedemption" OnClick="btnRedemptionClick"  runat="server" />
